...
app.get('/v1/models', async (req, res) => {
  try {
   ...
    
    console.log('返回模型列表:', JSON.stringify(models));
    res.json(models);
    
  } catch (error) {
...
app.post('/v1/chat/completions', async (req, res) => {
  try {
    console.log('收到聊天请求:', JSON.stringify(req.body));
    
   ...
    
    console.log('发送到Gemini的请求:', JSON.stringify(geminiRequest));
    
    // 调用Gemini API
   ...
    
    ...
    console.log('Gemini返回:', JSON.stringify(geminiData));
    
